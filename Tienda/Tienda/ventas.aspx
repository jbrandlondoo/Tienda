...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container" style="width:780px;margin-top:50px;">
            ...
            <asp:GridView ID="viewProducts" CssClass="table table-hover shopping-cart-wrap" gridlines="None" runat="server" OnRowCommand="viewProducts_RowCommand" Height="241px" Width="841px" AutoGenerateColumns="false">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ItemStyle-Width="250px">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="img/icons8-comprar-26.png" CommandName="Delete" />
